 ...
 **********************************************************************/
static void setup_tx_cal_tone(LMS7002M_t *self, const LMS7002M_chan_t channel, const float bw)
{
    LMS7002M_set_mac_ch(self, channel);
    const float txtsp_rate = self->cgen_freq;
    const float tx_nco_freq = bw;
    LMS7002M_txtsp_set_freq(self, channel, tx_nco_freq/txtsp_rate);

    const float rxtsp_rate = self->cgen_freq/4;
    const float rx_nco_freq = tx_nco_freq-1e6;
...
static int tx_cal_loop(
    LMS7002M_t *self, const LMS7002M_chan_t channel, const float bw,
 ...
 **********************************************************************/
static int tx_cal_tbb_lpfs5(LMS7002M_t *self, const LMS7002M_chan_t channel, const float bw)
{
    LMS7002M_set_mac_ch(self, channel);
    ...
    //--- setup rcal, path ---//
    const float f = bw/1e6;
    const float p1 = 1.93821841029921E-15;
    const float p2 = -0.0429694461214244;
    const float p3 = 0.253501254059498;
    const float p4 = 88.9545445989649;
    const float p5 = -48.0847491316861;
 ...
 **********************************************************************/
static int tx_cal_tbb_lpflad(LMS7002M_t *self, const LMS7002M_chan_t channel, const float bw)
{
    int status = 0;
    LMS7002M_set_mac_ch(self, channel);
    ...
    //--- setup rcal, path ---//
    const float f = bw/1e6;
    const float p1 = 1.29858903647958E-16;
    const float p2 = -0.000110746929967704;
    const float p3 = 0.00277593485991029;
    const float p4 = 21.0384293169607;
    const float p5 = -48.4092606238297;
 ...
 **********************************************************************/
static int tx_cal_tbb_lpfh(LMS7002M_t *self, const LMS7002M_chan_t channel, const float bw)
{
    int status = 0;
    LMS7002M_set_mac_ch(self, channel);
    ...
    //--- setup rcal, path ---//
    const float f = bw/1e6;
    const float p1 = 1.10383261611112E-06;
    const float p2 = -0.000210800032517545;
    const float p3 = 0.0190494874803309;
    const float p4 = 1.43317445923528;
    const float p5 = -47.6950779298333;
 ...
 **********************************************************************/
int LMS7002M_tbb_set_filter_bw(LMS7002M_t *self, const LMS7002M_chan_t channel, float bw, float *bwactual)
{
    LMS7002M_set_mac_ch(self, channel);
    int status = 0;
    ...
    const float lpflad_start = 3e6;
    const float lpflad_stop = 13e6;
    const float lpfh_start = 28e6;
    const float lpf5_start = lpflad_start; //FIXME -> 0.8e6
