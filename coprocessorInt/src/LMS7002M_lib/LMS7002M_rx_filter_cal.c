 ...
 **********************************************************************/
static int setup_rx_cal_tone(LMS7002M_t *self, const LMS7002M_chan_t channel, const float bw)
{
    LMS7002M_sxx_enable(self, LMS_RX, true);
    LMS7002M_sxt_to_sxr(self, false);
    int status = 0;
    LMS7002M_set_mac_ch(self, channel);
    const float sxr_freq = self->sxt_freq-bw;
    float sxr_freq_actual = 0;
    ...
    float rxtsp_rate = self->cgen_freq/4;
    const float rx_nco_freq = (self->sxt_freq-sxr_freq_actual)-1e6;
 ...
 **********************************************************************/
static int rx_cal_tia_rfe(LMS7002M_t *self, const LMS7002M_chan_t channel, const float bw)
{
    int status = 0;
    LMS7002M_set_mac_ch(self, channel);
    const int g_tia_rfe_user = LMS7002M_regs(self)->reg_0x0113_g_tia_rfe;
 ...
 **********************************************************************/
static int rx_cal_rbb_lpfl(LMS7002M_t *self, const LMS7002M_chan_t channel, const float bw)
{
    int status = 0;
    LMS7002M_set_mac_ch(self, channel);
 ...
 **********************************************************************/
static int rx_cal_rbb_lpfh(LMS7002M_t *self, const LMS7002M_chan_t channel, const float bw)
{
    LMS7002M_set_mac_ch(self, channel);
 ...
 **********************************************************************/
int LMS7002M_rbb_set_filter_bw(LMS7002M_t *self, const LMS7002M_chan_t channel, float bw, float *bwactual)
{
    LMS7002M_set_mac_ch(self, channel);
    int status = 0;
